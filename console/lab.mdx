...
Each Lab has a **name**, **image**, **GPU type** and **number of GPUs** as well as an optional _storage connection_.
...
We support different NVIDIA GPU types on our platform. Each type comes with an amount of VRAM (memory) and processing power. Each type also specifies the credits used per hour. We currently support:
- ```RTX 3090```
- ```RTX 4090```
- ```RTX A6000```
- ```RTX 8000```
